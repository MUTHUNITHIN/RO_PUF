...
HD_PWD='D:/AAM/RO_PUF_new/project_2/project_2.runs/design_2_mux_one_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_mux_one_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_mux_one_0_0.tcl
